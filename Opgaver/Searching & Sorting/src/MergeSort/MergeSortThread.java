 ...
 */
public class MergeSortThread<E extends Comparable<E>> implements Callable<E[]> {

    E[] arrList;

    public MergeSortThread(E[] list) {
        arrList = list;
    }
    ...
    private <E extends Comparable<E>> void merge(E[] list1, E[] list2, E[] temp){
